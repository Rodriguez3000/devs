...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Devsta - @yield('titulo')</title>
    ...
    <body class="bg-gray-100" >
            ...
            items-center">
                ...
                @auth
                    <nav class="flex gap-2" items-center>
                        <a 
                        class="felx items-center gap-2 bg-white border p-2
                        text-gray-600 rounded text-sm uppercase font-bold 
                        cursor-pointer " href="{{ route ('posts.create' )}}"
                        >
        ...
        uppercase">
            DevS- Todos los derechos reservados 
           {{ now()->year }}
        </footer>
